...
export function Problem() {
  ...
  return (
    ...
    >
      {/* Subtle red/orange background accent */}
      <div className="absolute inset-0 bg-gradient-to-b from-red-950/5 via-orange-950/5 to-transparent pointer-events-none" />

      <div className="relative mx-auto max-w-6xl px-6">
        <div className="text-center mb-12 scroll-animate">
          <span className="inline-block text-sm font-medium text-orange-400/80 mb-3 uppercase tracking-wider">
            O problema
          </span>
        ...
        <p className="scroll-animate mt-10 text-center text-lg font-medium text-zinc-300">
          ...
          <span className="text-orange-400">dinheiro</span> e{" "}
          <span className="text-orange-400">clientes</span>.
        </p>
      </div>
    </section>
  );
